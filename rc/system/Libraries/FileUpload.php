...
class FileUpload
{
    ...
    public function upload($fileNameAttribute)
    {
        $this->fileToUpload = $_FILES[$fileNameAttribute];
        $fileName = isset($this->fileName) ? $this->fileName : basename($this->fileToUpload['name']);
